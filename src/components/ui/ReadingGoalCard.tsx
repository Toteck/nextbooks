...
                <span className={cn("text-gray-500 font-medium", compact ? "text-base" : "text-xl")}>de</span>
                <Input
                  type="number"
                  label="" 
                  value={newGoal}
...
                  autoFocus
                />
                <Button onClick={handleSave} size="icon" className="bg-purple-600 hover:bg-purple-700">
